            ...
            <div class="relative mx-auto flex min-h-screen w-full max-w-4xl items-center justify-center">
                <div class="w-full rounded-[2rem] border border-white/10 bg-slate-900/95 p-8 shadow-2xl shadow-slate-950/40 backdrop-blur-xl sm:p-10">
                    <div class="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            <p class="text-sm font-semibold uppercase tracking-[0.28em] text-cyan-300">StockPilot</p>
                            <h1 class="mt-2 text-3xl font-semibold text-white sm:text-4xl">Modern authentication for your inventory app.</h1>
                        </div>
                        <div class="hidden rounded-full bg-white/5 px-4 py-2 text-sm text-slate-300 sm:block">Secure login</div>
                    </div>
